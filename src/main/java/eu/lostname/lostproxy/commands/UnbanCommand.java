        ...
        if (strings.length <= 1) {
            ...
            if (uuid != null) {
                ...
                if (iBan != null) {
                    ...
                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Der Spieler " + targetIPlayer.getDisplay() + targetIPlayer.getPlayerName() + " §7wurde §aentbannt§8.").build());
                    ...
                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Der Spieler " + targetIPlayer.getDisplay() + targetIPlayer.getPlayerName() + " §7ist §cnicht §7gebannt§8.").build());
                }
            } else {
