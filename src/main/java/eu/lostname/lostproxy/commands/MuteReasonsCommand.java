                ...
                if (iMuteReason != null) {
                    if (strings[1].equalsIgnoreCase("delete")) {
                        if (commandSender.hasPermission("lostproxy.command.mutereasons.delete")) {
                            commandSender.sendMessage(new MessageBuilder($.BKMS + "Soll der Mutegrund §e" + iMuteReason.getName() + " §8(§e" + iMuteReason.getId() + "§8) §7tatsächlich gelöscht werden§8.").build());
                        ...
                        if (commandSender.hasPermission("lostproxy.command.mutereasons.delete")) {
                            if (LostProxy.getInstance().getReasonManager().getMuteReasonCommandProcess().contains(commandSender.getName())) {
                                if (strings[2].equalsIgnoreCase("confirmed")) {
                                    ...
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Der Mutegrund §e" + iMuteReason.getName() + " §8(§e" + iMuteReason.getId() + "§8) §7wurde erfolgreich §cgelöscht§8.").build());
                                } else {
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Bitte beachte die §eBenutzung §7dieses Kommandos§8.").build());
                                }
                            } else {
                        ...
                        if (commandSender.hasPermission("lostproxy.command.mutereasons.set")) {
                            switch (strings[2]) {
                                case "id":
                                    ...
                                    LostProxy.getInstance().getReasonManager().reloadMuteReasons();
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Die neue ID des Mutegrunds §e" + iMuteReason.getName() + " §7lautet nun §a" + newId + "§8.").build());
                                    break;
                                case "name":
                                    ...
                                    LostProxy.getInstance().getReasonManager().saveMuteReason(iMuteReason);
                                    LostProxy.getInstance().getReasonManager().reloadMuteReasons();
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Der neue Name des Mutegrunds §e" + iMuteReason.getName() + " §8(§e" + iMuteReason.getId() + "§8) §7lautet nun §a" + iMuteReason.getName() + "§8.").build());
                                    break;
                                case "time":
                                    ...
                                    LostProxy.getInstance().getReasonManager().saveMuteReason(iMuteReason);
                                    LostProxy.getInstance().getReasonManager().reloadMuteReasons();
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Der neue Zeitwert des Mutegrunds §e" + iMuteReason.getName() + " §8(§e" + iMuteReason.getId() + "§8) §7ist nun §a" + iMuteReason.getTime() + "§8.").build());
                                    break;
                                case "timeunit":
                                    ...
                                    LostProxy.getInstance().getReasonManager().saveMuteReason(iMuteReason);
                                    LostProxy.getInstance().getReasonManager().reloadMuteReasons();
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Die neue Zeiteinheit des Mutegrunds §e" + iMuteReason.getName() + " §8(§e" + iMuteReason.getId() + "§8) §7ist nun §a" + ETimeUnit.getDisplayName(0, eTimeUnit) + "§8.").build());
                                    break;
                                case "permission":
                                    ...
                                    LostProxy.getInstance().getReasonManager().saveMuteReason(iMuteReason);
                                    LostProxy.getInstance().getReasonManager().reloadMuteReasons();
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Die neue Berechtigung für den Mutegrund §e" + iMuteReason.getName() + " §8(§e" + iMuteReason.getId() + "§8) §7ist nun §a" + iMuteReason.getPermission() + "§8.").build());
                                    break;
                                default:
                                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Bitte beachte die §eBenutzung §7dieses Kommandos§8.").build());
                                    break;
                ...
                try {
                    ...
                    if (LostProxy.getInstance().getReasonManager().getMuteReasonByID(id) == null) {
                        ...
                        if (eTimeUnit != null) {
                            ...
                            LostProxy.getInstance().getReasonManager().saveMuteReason(iMuteReason);
                            LostProxy.getInstance().getReasonManager().reloadMuteReasons();
                            commandSender.sendMessage(new MessageBuilder($.BKMS + "Du hast §aerfolgreich §7den Mutegrund §e" + name + " §7mit der ID §e" + id + " §7erstellt§8.").build());
                        } else {
                            commandSender.sendMessage(new MessageBuilder($.BKMS + "Die angegebene §eZeiteinheit §7wurde §cnicht §7gefunden§8.").build());
                        }
                    } else {
                        commandSender.sendMessage(new MessageBuilder($.BKMS + "Es existiert §cbereits §7ein Mutegrund mit der ID §e" + id + "§8.").build());
                    }
                } catch (NumberFormatException numberFormatException) {
                    commandSender.sendMessage(new MessageBuilder($.BKMS + "Du hast als Argument §ckeine §7Zahl angegeben§8.").build());
                }
            } else {
                commandSender.sendMessage(new MessageBuilder($.BKMS + "Bitte beachte die §eBenutzung §7dieses Kommandos§8.").build());
            }
